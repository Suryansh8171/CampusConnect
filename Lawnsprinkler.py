...
from pyjs import *
WATERLEVEL_RATE = 0.1 # 0.1 cm per second WATERLEVEL_RATE
HUMIDITY_RATE = 5. / 3600 # 5% per hour VOLUME_AT_RATE = 100000. # var VOLUME_AT_RATE MAX_RATE = 1.e6 # var MAX_RATE
...
def setState (newState): 
    ...
    setDeviceProperty(getName(), "state", state) u
    pdateEnvironment()
# var value
...
def updateEnvironment (): 
    if state == 1:
        ...
        Environment.setContribution("Water Level", 0, 0, True) Environment.setContribution("Humidity", 0, 0, True)
